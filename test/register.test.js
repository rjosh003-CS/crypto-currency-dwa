...
describe("Mock Test - POST /register", () => {
    it("should register a user and return a success message", async () => {
        ...
        axios.post = jest.fn().mockResolvedValueOnce({ data: { message: "User registered successfully" } });
    ...
    it("should return an error if required fields are missing", async () => {
        ...
        // Mocking the axios post method
        axios.post = jest.fn().mockRejectedValueOnce({ response: { data: { error: "Missing required fields" } } });
